...
# Finance: vincula cada venda ao movimento de estoque exato.
...
# Operations: migration e exclusão/restauração pelo ID do movimento.
...
# Versão v0.2.1, sem tocar em workflows.
